...
# window size
window_width = int((top_button_width_pref) * 8)  
window_height = int((top_button_height_pref) + (left_button_height_pref) * 2)
# window_width = int((top_button_width_pref) * 4)  
# window_height = int((top_button_height_pref) + (left_button_height_pref) * 6)
