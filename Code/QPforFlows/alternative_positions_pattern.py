...
# widths and heights
top_button_width_min = 8
top_button_width_pref = 80
top_button_width_max = 800
top_button_height_min = 8
top_button_height_pref = 80
top_button_height_max = 800
left_button_width_min = 8
left_button_width_pref = 80
left_button_width_max = 800
left_button_height_min = 8
left_button_height_pref = 80
left_button_height_max = 800
textbox_min = 0
textbox_pref = 700
textbox_max = 1000000
textbox_width = 200
...
num_left = 8
total = 100
num_top = randint(3, total-3)
num_left = total - num_top

# window size
window_width = 360
window_height = 400
window_width = randint(36, 3000)
window_height = randint(40, 3000)
